 ...
 * @subpackage ims_Social_Chat/public/partials
 */

global $product;
$gSetting = get_option('ims-whatsapp-setting-field-M');
$wTitle = ($gSetting['whatsapp_content']) ? $gSetting['whatsapp_content'] : '';
$bgcolor = isset($gSetting['ims_whatsapp_btn_color']) ? $gSetting['ims_whatsapp_btn_color'] : '';

$color = isset($gSetting['ims_whatsapp_txtbtn_color']) ? $gSetting['ims_whatsapp_txtbtn_color'] : '';
...
<div id="chatPage" class="chat_page">
    ...
    <div id="chatbar" class="chat_box animated fadeInUp">
        ...
        <div id="chatBody" class="chat_box_body">
            <div class="awc_mContent" id="ims_style-16">
                <?php
                ...
                $args = array('post_type' => 'ims_whatsapp_agent', 'posts_per_page' => -1);
                ...
                if ($member_query->have_posts()) {
                    while ($member_query->have_posts()) : $member_query->the_post();
                        ...
                        $member_custom_field = get_post_meta($get_cust_id, '_ims_wtp_member_acc_', true);

                        $allDay = $member_custom_field['ims_member_all_days'];
                        $member_text = get_post_meta($get_cust_id, '_ims_wtp_member_acc_', true);
                        $member_text_message= $member_text['ims_member_message'];
                        if($member_text_message !="" || !empty($member_text_message)){
                          $text=$member_text['ims_member_message'];
                        }else{
                        $text = ($gSetting['whatsapp_start_chat']);
                        }
                        if ($allDay) {
                            ...
                            $wDays = $member_custom_field['ims_member_weekdays'];
                        ...
                        if ($mClass == 'awc_online') {
                            ...
                            $mUrl .= '.whatsapp.com/send?phone=' . $member_custom_field['ims_member_number'] . '&text=' . $text;
                        ...
                        <div class="awc_sMember <?php echo $mClass; ?> ">
                            <a href="<?php echo $mUrl; ?>" <?php echo $target; ?> onclick="gtag('event', 'WhatsApp', {'event_action': 'whatsapp_chat', 'event_category': 'Chat', 'event_label': 'Chat_WhatsApp'});">
                                ...
                                <div class="awc_mData tt">
                                    ...
                                    <p class="awc_mStatus"><?php echo $member_custom_field['ims_member_position']; ?></p>
                                    ...
                                    <?php if ($mClass == 'awc_offline') {
                                        ...
                                        echo $member_custom_field['ims_member_btntext'];
                                    } ?>
                                </div>
